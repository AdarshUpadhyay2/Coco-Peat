const ProductFile = [
  {
    ...
    specifications: [
      { property: "Type", value: "Washed / Buffered" },
      { property: "Particle size", value: "0-8 mm" },
      { property: "Coco Peat Content", value: "40%" },
      { property: "Husk chip size", value: "0-12 mm" },
      { property: "Husk chip content", value: "40%" },
      { property: "Fiber size", value: "0-1.5 CM" },
      { property: "Fiber content", value: "20%" },
      { property: "Dimension", value: "30cm x 30 cm x (10-12) cm" },
      { property: "Weight", value: "5.0 kg ± 0.5 kg" },
      { property: "Electrical conductivity", value: "<=1.0 mS/cm" },
      { property: "pH", value: "5.5 to 6.5" },
      { property: "Water expansion", value: "75 L" },
      { property: "Moisture", value: "15%" },
    ],
    price: 20.0,
    images: [
      "../../public/img/Product/CocoSubstrates/CocoSubstrateCustomMix.png",
      "../../public/img/Product/CocoSubstrates/img1.webp",
      "../../public/img/Product/CocoSubstrates/img2.png",
    ],
    application: [
      "Horticultural applications for enhanced soil hydration and drainage.",
      "Ideal for mixing with other substrates based on customer specifications.",
    ],
    delivery: [
      "Available for local and international shipping within 7-10 business days.",
  ...
  },
  {
    ...
    specifications: [
      { property: "Cocopeat Particle size", value: "0-8 mm" },
      { property: "Cocopeat Content", value: "30%" },
      { property: "Fiber size", value: "0-20 mm" },
      { property: "Fiber content", value: "70%" },
      { property: "Dimension", value: "30cm x 30 cm x (10-12) cm" },
      { property: "Weight", value: "5.0 kg ± 0.5 kg" },
      { property: "Electrical conductivity", value: "<=1.0 mS/cm" },
      { property: "pH", value: "5.5 to 6.5" },
    ...
    price: 15.0,
    images: ["../../public/img/Product/CocoSubstrates/CocoSubstrateFiber.png",],
    application: [
      "Ideal for improving soil aeration and drainage in horticulture.",
      "Used as a component in potting mixes.",
    ],
    delivery: [
      "Ships within 5-7 business days with tracking available.",
      "Express delivery options are also available.",
    ],
    suitableFor: ["Potting mixes.", "Seed starting.", "Soil amendments."],
    benefits: [
  ...
  },
  {
    ...
    specifications: [
      { property: "Husk chip size", value: "0-12 mm, 4-14 mm, 4-18 mm" },
      { property: "Husk chip content", value: "100%" },
      { property: "Dimension", value: "30cm x 30 cm x (10-12) cm" },
      { property: "Weight", value: "5.0 kg ± 0.5 kg" },
      { property: "Electrical conductivity", value: "<=1.0 mS/cm" },
      { property: "pH", value: "5.5 to 6.5" },
      { property: "Water expansion", value: "50 – 60 L" },
      { property: "Moisture", value: "15%" },
    ],
    price: 18.0,
    images: [
      "../../public/img/Product/CocoSubstrates/husk-chip-mix.png", // Replace with an actual image URL
    ],
    application: [
    ...
    delivery: [
      "Delivery within 7-10 business days depending on location.",
      "Standard and expedited shipping options available.",
    ],
    suitableFor: ["Hydroponic systems.", "Container gardening.", "Soil mixes."],
    benefits: [
    ...
    specifications: [
      {
        ...
        value: "0-6 mm, 0-8 mm, 1-6 mm, 1-8 mm and custom sizes",
      },
      { property: "Dimension", value: "30cm x 30 cm x (10-12) cm" },
      { property: "Weight", value: "5.0 kg ± 0.5 kg" },
      {
        property: "Electrical conductivity",
        value: "<=0.5 mS/cm, <=1.0 mS/cm",
      },
      { property: "pH", value: "5.5 to 6.5" },
      { property: "Water expansion", value: "70-75 L" },
      { property: "Moisture", value: "15%" },
    ],
    price: 17.0,
    images: [
      "../../public/img/Product/CocoSubstrates/cooc-fine-coarses.jpeg", // Replace with an actual image URL
    ],
    application: [
      "Used for improving soil hydration and aeration.",
      "Can be mixed with other substrates for custom applications.",
    ],
    delivery: [
      "Ships within 5-7 business days with express options available.",
      "Delivery available across multiple regions.",
    ],
    suitableFor: [
  ...
  },
  {
    ...
    specifications: [
      ...
      { property: "Dimension", value: "30cm x 30 cm x (10-12) cm" },
      { property: "Weight", value: "5.0 kg ± 0.5 kg" },
      { property: "Age", value: "8 to 10 months" },
      { property: "Minerals", value: "<6.0 m.mol/l" },
      { property: "Sodium", value: "<1.7 m.mol/l" },
      {
        property: "Electrical conductivity",
        value: "<=1.0 mS/cm",
      },
      { property: "pH", value: "5.5 to 6.5" },
      { property: "Water expansion", value: "	75 L" },
      { property: "Moisture", value: "<=18%" },
    ],
    price: 16.0,
    images: [
      "../../public/img/Product/CocoSubstrates/CocoSubstratesBuffered.png", // Replace with an actual image URL
    ],
    application: [
      "Improves drainage and aeration for optimal root growth.",
      "Suitable for potting mixes and container gardening.",
    ],
    delivery: [
    ...
    suitableFor: ["Potting mixes.", "Container gardening.", "Horticulture."],
    benefits: [
  ...
  },
  {
    ...
    specifications: [
      { property: "Colour", value: "Brown / White" },
      { property: "Bale Weight", value: "115 Kg – 125 Kg / Bale" },
      { property: "Size", value: "48 x 30 x 18 inch" },
      { property: "Moisture", value: "< 15%" },
      { property: "Impurity", value: "< 5%" },
      { property: "Fibre Length", value: "5 cm to 25 cm" },
      { property: "Long Fiber", value: "> 75%" },
      { property: "Short Fiber", value: "< 25%" },
    ],
    price: 40.0,
    images: [
      "../../public/img/Product/CoirFiber/Bales.png", // Replace with an actual image URL
    ],
    application: [
      "Used in upholstery.",
      "Provides sound insulation.",
      "Used for thermal insulation.",
      "Manufacturing of artificial coir wood.",
    ],
    delivery: [
      "Compressed bales in 20 Feet or 40 Feet Container with Euro pallet.",
      "Delivered worldwide at doorstep with custom clearance and local transport.",
    ],
  },
  {
    id: 7,
    ...
    specifications: [
      { property: "Colour", value: "Brown / Golden brown / White" },
      { property: "Bale Weight", value: "115 Kg – 125 Kg / Bale" },
      { property: "Diameter", value: "15 x 20 x 25 cm" },
      { property: "Fibre Length", value: "5 cm to 20 cm" },
      { property: "Moisture", value: "< 15%" },
      { property: "Impurity", value: "< 5%" },
      { property: "Twists", value: "23 x 19 x 17 per foot" },
      { property: "Weight", value: "25 kg / spool (average)" },
    ],
    price: 35.0,
    images: [
      "../../public/img/Product/CoirFiber/TwistedSpool.png", // Replace with an actual image URL
    ],
    application: [
      "Used in upholstery.",
      "Provides sound insulation.",
    ...
    delivery: [
      "20 Feet or 40 Feet Container with Euro pallet.",
      "Delivered worldwide at doorstep with custom clearance and local transport.",
    ],
  },
  {
    ...
    images: [
      "../../public/img/Product/ErosionControl/CoirLogs.webp", // Replace with an actual image URL
    ],
    application: [
      ...
      "Construction slope stabilization.",
    ],
    delivery: [
      "Euro palette loading or floor loading in 20ft / 40ft containers.",
      "Delivered worldwide at doorstep including custom clearance and local transport.",
    ],
  },
  {
    id: 9,
    ...
    specifications: [
      ...
      {
        property: "Dimension",
        value: "1m x 50m, 2m x 50m, 3m x 50m, 4m x 50m, custom size",
      },
    ],
    price: 30.0, // Adjust price as needed
    images: [
      "../../public/img/Product/ErosionControl/GeoTextiles.webp", // Replace with an actual image URL
    ],
    application: [
      "Reforestation.",
  ...
  },
  {
    ...
    specifications: [
      { property: "Diameter (inch)", value: "8, 10, 12, 14" },
      { property: "Shape", value: "Half round, Cone" },
      { property: "Hanging", value: "Black steel frame" },
    ],
    price: 25.0, // Adjust price as needed
    images: [
      "../../public/img/Product/GardenArticles/CocoBasket.png", // Replace with an actual image URL
    ],
    application: [
      "Indoor at home or office.",
      "Outdoor at balcony or winter garden.",
    ],
    delivery: [
      "20 Feet or 40 Feet Container with Euro pallet.",
      "Delivered worldwide at doorstep with custom clearance and local transport.",
    ...
    suitableFor: ["Wholesale and retailers.", "Hobby and home gardeners."],
  },
  {
    id: 11,
    name: "Coco Bricks",
    ...
    specifications: [
      ...
      {
        property: "Dimension",
        value: "20cm x 10cm x 5cm / 30cm x 30cm x 12cm",
      },
      { property: "Weight", value: "750g ± 100g / 5.0 kg ± 0.5 kg" },
      { property: "Electrical conductivity", value: "<=0.5 mS/cm" },
      { property: "pH", value: "5.5 to 6.5" },
      { property: "Water expansion", value: "10 L approx. / 75 L approx." },
      { property: "Moisture", value: "15%" },
    ],
    images: [
      "../../public/img/Product/GardenArticles/CocoBricks.png", // Replace with an actual image URL
    ],
    benefits: [
      "Coco substrate as a growing medium provides optimum drainage and aeration conditions for seed germination.",
      "When used in combination with coco pots, transplantation shocks and root damages can be avoided by directly planting the coco pot into the soil.",
    ],
    application: ["Home gardening.", "Hobby gardening."],
    suitableFor: [
      "Garden centers.",
  ...
  },
  {
    ...
    specifications: [
      {
        property: "Seed germination pot",
        value:
          "Coco pot small / Coco pot medium / Coco pot large / Coco pot extra large",
      },
      { property: "Height (cm)", value: "5 / 8 / 9 / 11 / 21" },
      { property: "Top diameter (cm)", value: "6.5 / 8 / 10.5 / 15 / 25" },
      { property: "Bottom diameter (cm)", value: "3.5 / 5 / 7.5 / 11 / 19" },
    ],
    images: [
      "../../public/img/Product/GardenArticles/CocoPot.png", // Replace with an actual image URL
    ],
    benefits: [
  ...
  },
  {
    ...
    specifications: [
      ...
      {
        property: "Expansion volume (ml)",
        value: "30 / 70 to 80 / 300 to 350 / 650 to 700 / 750 to 800",
      },
    ],
    images: [
      "../../public/img/Product/GardenArticles/CocoDisks.png", // Replace with an actual image URL
    ],
    benefits: [
  ...
  },
  {
    ...
    specifications: [
      {
        ...
        value: "Top diameter x Bottom Diameter x Height: 10.5 x 7.5 x 9.0",
      },
      { property: "Coco disk diameter (cm)", value: "4.0" },
      { property: "Coco disk expansion (ml)", value: "70 to 80" },
      { property: "Seed", value: "Optional" },
      { property: "Outer cover", value: "Recycled paper" },
    ],
    images: [
      "../../public/img/Product/GardenArticles/CocoGrowKit.png", // Replace with an actual image URL
    ],
    application: [
    ...
    suitableFor: [
      "Parents and guardians looking to engage children in gardening.",
      "Schools and educational programs focused on environmental awareness.",
    ],
    delivery: [
      "20 Feet or 40 Feet Container with Euro pallet.",
      "Delivered worldwide at doorstep with custom clearance and local transport.",
    ...
    specifications: [
      {
        ...
        value:
          "100% Cocopeat, Cocopeat + Husk Mix, Cocopeat + Fiber Mix, and 100% Coco Crush. Available in washed, unwashed, and buffered growbags.",
      },
      {
        property: "Dimensions",
        value:
          "90 x 15, 90 x 18, 90 x 20, 100 x 15, 100 x 18, 100 x 20, 120 x 15, 120 x 18, 120 x 20",
      },
    ],
    images: [
      "../../public/img/Product/GrowBags/BarType.png", // Replace with an actual image URL
    ],
    suitableFor: [
      "Vegetables like Tomato, Capsicum, Zucchini, Brinjal, etc.",
      "Leafy vegetables like Spinach, Lettuce, etc.",
      "Soft fruits like Strawberry, Raspberry, Blueberry, Blackberry, etc.",
      "Cut flowers",
      "Ornamental plants",
      "Medicinal Cannabis",
    ],
    benefits: [
      "Growbags can be reused for multiple harvest seasons over several years due to the coco substrate's efficient drainage and low decomposition rate.",
      "Growbags can be replaced individually in case of contamination or infection, saving cost and time.",
      "Coco substrate is biodegradable and 100% organic. It can be easily disposed of after several years of use to top-up existing soil or as potting mix.",
      "Plant holes, dripper holes, and drainage holes can be customized.",
    ],
    delivery: [
      "20 Feet or 40 Feet Container with Euro pallet.",
      "Delivered worldwide at doorstep with custom clearance and local transport.",
      "Private labelling accepted.",
    ],
  },
  {
    id: 16,
    ...
    specifications: [
      ...
      {
        property: "Volume (Liters)",
        value:
          "Available in 3.5, 5, 7.5, and 10 Liters and other custom requirements.",
      },
      {
        property: "Dimensions (cm)",
        value:
          "18 x 18 x 6, 18 x 18 x 8, 18 x 18 x 10, 18 x 18 x 14, 20 x 20 x 6, 20 x 20 x 8, 20 x 20 x 10, 20 x 20 x 14.",
      },
      {
        property: "Custom Sizes",
        value: "Custom sizes available to meet individual requirements.",
      },
    ],
    images: [
      "../../public/img/Product/GrowBags/OpenTop.png", // Replace with an actual image URL
    ],
    suitableFor: [
      "Vegetables like Tomato, Capsicum, Zucchini, Brinjal, etc.",
      "Leafy vegetables like Spinach, Lettuce, etc.",
    ...
    advantages: [
      "Growbags can be reused for multiple harvest seasons over several years due to the coco substrate's efficient drainage and low decomposition rate.",
      "Growbags can be replaced individually in case of contamination or infection, resulting in cost and time savings.",
      "High anchoring support for plant roots.",
      "Coco substrate is biodegradable and 100% organic. It can be easily disposed of after several years of use to top-up existing soil or as potting mix.",
    ],
    delivery: [
      "20 Feet or 40 Feet Container with Euro pallet.",
  ...
  },
  {
    ...
    specifications: [],
    images: [
      "../../public/img/Product/PlantProtection/NeemOil.png", // Replace with an actual image URL
    ],
  ...
  },
  {
    ...
    specifications: [],
    images: [
      "../../public/img/Product/PlantProtection/NeemSeedPowder.png", // Replace with an actual image URL
    ],
