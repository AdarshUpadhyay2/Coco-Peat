      ...
      <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 mt-10 text-center sm:mt-16 sm:grid-cols-2 sm:gap-x-12 gap-y-12 md:grid-cols-3 md:gap-0 xl:mt-24">
          <div class="md:p-8 lg:p-14 flex flex-col items-center">
            ...
            Our products are derived from renewable coconut plantations, processed using environmentally friendly methods that ensure minimal ecological impact.
            </p>
          </div>
          ...
          <div class="md:p-8 lg:p-14 md:border-l md:border-gray-200 flex flex-col items-center">
            ...
            <p class="mt-5 text-base text-gray-600 font-pj">
            Our products are pure, promoting healthy plant growth and sustainability without synthetic additives.
            </p>
          </div>
          ...
          <div class="md:p-8 lg:p-14 md:border-l md:border-gray-200 flex flex-col items-center">
            ...
            <p class="mt-5 text-base text-gray-600 font-pj">
            Enriched with beneficial microbes like Trichoderma, our coco peat protects plants from harmful pathogens.
            </p>
          </div>
        </div>
      </div>
